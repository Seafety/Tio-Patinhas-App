    ...
    <div className={styles.carteiraOverview}>
      ...
      <div className={styles.stats}>
        ...
        <div className={styles.valueTotal}>
          <span className={styles.amount}><p style={{fontSize:'15px', color:'#00C287'}}>$</p>1892.25</span>
          <span className={styles.label}>Entradas</span></div>
        </div>
        <div className={styles.expense}>
        <span className={styles.icon}><img src={arrowDown}></img></span>
        <div className={styles.valueTotal}>
          <span className={styles.amount}><p style={{fontSize:'15px', color:'#E72D04'}}>$</p>387.47</span>
          <span className={styles.label}>Gastos</span></div>
        </div>
