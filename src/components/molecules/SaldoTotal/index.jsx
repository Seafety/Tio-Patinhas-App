    ...
    <div className={styles.saldoTotal}>
      ...
      >
        ...
        <div className={styles.cartaoInfo}>
          <img
            src={cartoes[cartaoAtual].icone}
            alt={cartoes[cartaoAtual].tipo}
          />
          <span className={styles.limite}>
            R${cartoes[cartaoAtual].limite.toLocaleString("pt-BR")}
          </span>
        </div>
      </div>

      <div className={styles.navegacao}>
        <button onClick={handleAnterior} disabled={cartaoAtual === 0}>
          ◂ Anterior
        </button>
